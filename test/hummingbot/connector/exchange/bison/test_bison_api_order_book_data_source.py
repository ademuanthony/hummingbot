...
from hummingbot.connector.exchange.bison import bison_constants as CONSTANTS, bison_web_utils as web_utils
...
class BisonAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.connector = BisonExchange(
            ...
            domain=self.domain)
        self.data_source = BisonAPIOrderBookDataSource(
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.bison.bison_api_order_book_data_source"
           ".BisonAPIOrderBookDataSource._sleep")
