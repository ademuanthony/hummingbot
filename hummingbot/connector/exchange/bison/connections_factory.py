...
from hummingbot.connector.exchange.bison.rest_connection import RESTConnection
...
class ConnectionsFactory:
    ...
    def __init__(self, bison_cert_path: str = None):
    ...
    async def get_rest_connection(self) -> RESTConnection:
        ...
        connection = RESTConnection(aiohttp_client_session=shared_client, bison_cert_path=self.bison_cert_path)
        return connection
