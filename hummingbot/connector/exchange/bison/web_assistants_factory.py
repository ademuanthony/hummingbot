...
from hummingbot.connector.exchange.bison.connections_factory import ConnectionsFactory
...
class WebAssistantsFactory:
    ...
    def __init__(
        ...
        self._connections_factory = ConnectionsFactory(bison_cert_path=bison_cert_path)
        ...
        self._auth = auth
        self.bison_cert_part = bison_cert_path
